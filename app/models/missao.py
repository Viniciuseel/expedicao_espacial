...
class Mission(db.Model):
    ...
    def __init__(self, nome_missao, data_lancamento, data_final , destino,  tripulacao , carga_util, duracao , custo, status, status_detalhado):
    ...
    def listarPorData(self, dataInicial, dataFinal):
        try:
            missoes = db.session.query(Mission).filter((Mission.data_lancamento >= dataInicial) & (Mission.data_final <= dataFinal)).order_by(Mission.data_lancamento.desc()).all()
            return missoes
        
        except Exception as e:
            print(e)
    
    def criarMissao(self, nome_missao, data_lancamento, data_final , destino,  tripulacao , carga_util, duracao , custo, status, status_detalhado ):
        try:
            add_banco = Mission(self, nome_missao, data_lancamento, data_final , destino,  tripulacao , carga_util, duracao , custo, status, status_detalhado)
            print(add_banco)
